...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibnJveSIsImEiOiJja3FhaWZ1amQwZGFyMm9sOTh5d3NyeTM5In0.C8o0soacyAeMGuO1gFDFvQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/updateMyPassword' : 'http://localhost:3000/api/v1/users/updateMe'; // ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword'
...
var userPasswordForm = document.querySelector('.form-user-password'); // const userDataForm = document.getElementById('userData');
